...
const panels={
about:{kicker:'LEARN • CREATE • TOGETHER',title:'เกี่ยวกับโครงการ',body:`<p>DDN Robot คือพื้นที่แห่งการเรียนรู้และสร้างสรรค์ ผ่านการลงมือพัฒนาหุ่นยนต์ การเขียนโปรแกรม และการแก้ปัญหาร่วมกัน</p><p>ส่งเสริมให้เยาวชนกล้าคิด กล้าทดลอง และนำความรู้ด้านเทคโนโลยีมาสร้างผลงานของตนเอง พร้อมแลกเปลี่ยนประสบการณ์กับเพื่อน ๆ ในสนามแข่งขัน</p><ul><li>ฝึกทักษะการเขียนโปรแกรมและควบคุมหุ่นยนต์</li><li>พัฒนาความคิดสร้างสรรค์และการแก้ปัญหา</li><li>เรียนรู้การทำงานเป็นทีมและน้ำใจนักกีฬา</li></ul>`},
